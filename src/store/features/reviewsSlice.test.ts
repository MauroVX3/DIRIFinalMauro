...
import reducer, { deleteReview, fetchMyReviews, saveReview } from './reviewsSlice'
import type { Review } from '../../types/entities'

const review: Review = { id: 4, movieId: 2, userId: 3, rating: 5, title: 'Gran película', content: 'Una reseña con más de veinte caracteres.', userName: 'Mauro' }
