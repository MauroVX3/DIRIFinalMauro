    ...
    <>
      ...
      <section className="page-section container">
        <div className="section-heading">
          <h2>{intl.formatMessage({ id: 'home.featured' })}</h2>
          <Link className="button-secondary" to="/movies">{intl.formatMessage({ id: 'home.explore' })}</Link>
        </div>
      ...
      <section className="page-section home-reviews-section">
        <div className="container">
          <div className="section-heading">
            <h2>{intl.formatMessage({ id: 'reviews.title' })}</h2>
            <Link className="button-secondary" to="/reviews">{intl.formatMessage({ id: 'home.recentReviews' })}</Link>
          </div>
